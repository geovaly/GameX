...
{
    public abstract class RequestHandler<TRequest, TResult> : IRequestHandler<TRequest, TResult> where TRequest : Request<TResult>
    {
    ...
    public abstract class CommandHandler<TCommand, TResult> : RequestHandler<TCommand, TResult> where TCommand : Command<TResult>
    {

    }

    public abstract class QueryHandler<TQuery, TResult> : RequestHandler<TQuery, TResult> where TQuery : Query<TResult>
    {
    }
